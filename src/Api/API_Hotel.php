...
class API_Hotel extends API_Base
{
    ...
    public function get_hotel_facility_types(array $options = [])
    {
        return $this->_do_request('hotelFacilityTypes', $options);
    }

    public function get_changed_hotels(array $options = [])
    {
